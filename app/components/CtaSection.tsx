  ...
  return (
      <section className="px-4 py-20 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-4xl rounded-3xl bg-linear-to-r from-primary to-third px-8 py-16 text-center shadow-xl sm:px-12">
          ...
          <Link
            href="/contact"
            className="group inline-flex items-center gap-2 rounded-xl bg-white px-8 py-3.5 text-lg font-bold text-primary shadow-lg transition-all hover:scale-105"
          >
            تواصل معنا الآن
