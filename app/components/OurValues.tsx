...
const values = [
  {
    title: "نُمكّن الهوية",
    description:
      "ندعم الشباب للتعبير عن هويتهم بطريقة تعكس قيم المواطنة، الاحترام، والانفتاح.",
  },
  {
    title: "نصون ثقافتنا",
    description:
      "نُؤمن أن الوعي يبدأ من فهم الثقافة الوطنية وحمايتها من التهميش، بروح مسؤولة ومستنيرة.",
  },
  {
