...
const objectives = [
  " تعزيز وعي الشباب بأهمية المشاركة في الحياة العامة ودورهم في المساهمة في تنمية المجتمع وخدمة الصالح العام...",
  " توفير تكوين منهجي لـ 50 إلى 100 شاب(ة)  في مجالات العمل السياسي ,المدني و المهارات القيادية و التواصلية.",
  "تنمية فهم آليات عمل المجالس المنتخبة وصناعة القرار.",
  "تقديم تجارب تطبيقية ومحاكاة لدعم الانخراط الفعلي في الشأن العام.",
];

const expectedResults = [
  "رتفاع اهتمام الشباب بالمشاركة في الحياة العامة.",
  "تعزيز مستوى الوعي السياسي لدى المشاركين.",
  "تأهيل ما لا يقل عن 20 شابا .",
...
const solutions = [
  {
    icon: "01",
    title: "تكوين متدرج",
    body: "برنامج تدريبي متكامل يجمع بين المعارف النظرية والتطبيقات العملية في مجالات العمل المدني، والمشاركة السياسية، والقيادة، والحياة العامة.",
  ...
  },
  {
    icon: "02",
    title: "مسارات متخصصة",
    body: "ورشات تكوينية في المواطنة، والحوكمة، والسياسات العامة، والتواصل، والقيادة، وإدارة المبادرات المجتمعية، بما يعزز قدرات الشباب على المشاركة الفعالة في الشأن العام..",
    accent: "bg-primary/8 border-primary/20",
    iconColor: "text-primary",
  },
  {
    ...
    body: "جلسات تطبيقية وتمارين محاكاة وورشات تفاعلية تُمكّن الشباب من فهم آليات العمل المدني والسياسي واكتساب الخبرة العملية في إدارة المبادرات وصناعة المقترحات والحوار العام..",
    accent: "bg-primary/8 border-primary/20",
    iconColor: "text-primary",
  },
];
      ...
      <div className="mx-auto w-full max-w-6xl space-y-14">
        ...
        <div className="pr-6">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-500">
            يستجيب برنامج البوصلة للحاجة المتزايدة إلى تأهيل الشباب للمشاركة
            الفعالة في الحياة العامة، من خلال مسار تكويني يجمع بين البعدين
            المدني والسياسي، ويهدف إلى تنمية الوعي والمعرفة والمهارات اللازمة
            للإسهام الإيجابي في المجتمع والشأن العام.
          </p>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="group relative overflow-hidden rounded-3xl bg-rose-50 p-8 border border-rose-100">
            ...
            <p className="mt-4 text-base leading-8 text-rose-800/80">
              عزوف متزايد لدى الشباب عن الانخراط والمشاركة المجتمع مقابل غياب
              التوعية و التكوين الجاد.
            </p>
            {/* decorative number */}
